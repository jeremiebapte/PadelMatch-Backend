// Path: PadelMatch-Backend/functions/index.js

// ======================================================
// PadelMatch – Cloud Functions (Node 22, Admin SDK 12) – Gen2
// Version propre – Android + iOS – ciblage intelligent
// ======================================================
...
async function purgeTokens(uid, tokens) {
  ...
  const delMap = {};
  tokens.forEach((t) => {
    delMap[`fcmTokens.${t}`] = FieldValue.delete();
  });
...
// ======================================================
// Trigger — NEW MATCH (ciblage intelligent)
// ======================================================
